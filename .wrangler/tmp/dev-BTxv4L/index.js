...
// src/endpoints/weather/getWeatherByLocation.ts
var getWeatherByLocation = /* @__PURE__ */ __name(async (c) => {
  try {
...
// src/endpoints/weather/getWeatherLondon.ts
var getWeatherLondon = /* @__PURE__ */ __name(async (c) => {
  try {
    const apiKey = c.env.OPENWEATHER_API_KEY || "demo";
    const weatherResponse = await fetch(
...
function isAnyZodType2(schema2) {
  return schema2._def !== void 0;
}
__name(isAnyZodType2, "isAnyZodType");
...
function legacyTypeIntoZod(type2, params) {
  params = params || {};
  if (type2 === null) {
    return Str({ required: false, ...params });
  }
  if (isAnyZodType2(type2)) {
    if (params) {
      return convertParams(type2, params);
    }
    return type2;
  }
  if (type2 === String) {
  ...
  if (typeof type2 === "string") {
    return Str({ example: type2 });
  }
  if (type2 === Number) {
    return Num(params);
  }
  if (typeof type2 === "number") {
    return Num({ example: type2 });
  }
  if (type2 === Boolean) {
    return Bool(params);
  }
  if (typeof type2 === "boolean") {
    return Bool({ example: type2 });
  }
  if (type2 === Date) {
  ...
  if (Array.isArray(type2)) {
    ...
    return Arr(type2[0], params);
  }
  if (typeof type2 === "object") {
    return Obj(type2, params);
  }
  return type2(params);
}
__name(legacyTypeIntoZod, "legacyTypeIntoZod");
...
function Obj(fields, params) {
  ...
  return convertParams(external_exports.object(parsed), params);
}
__name(Obj, "Obj");
function Num(params) {
  return convertParams(external_exports.number(), params).openapi({
    type: "number"
  });
}
__name(Num, "Num");
...
function Bool(params) {
  return convertParams(external_exports.boolean(), params).openapi({
    type: "boolean"
  });
}
__name(Bool, "Bool");
...
var contentJson = /* @__PURE__ */ __name((schema2) => ({
  content: {
    "application/json": {
      schema: schema2 instanceof external_exports.ZodType ? schema2 : legacyTypeIntoZod(schema2)
    }
  }
}), "contentJson");
...
// src/endpoints/weather/router.ts
...
var signup = /* @__PURE__ */ __name(async (c) => {
  try {
...
// src/docs/endpoints/weather/getWeatherByLocation.ts
var WeatherResponseSchema = external_exports.object({
  ...
  data: external_exports.object({
    ...
    weather: external_exports.object({
      ...
      feels_like: external_exports.number(),
      humidity: external_exports.number(),
      wind_speed: external_exports.number()
    }),
    fact: external_exports.string().nullable()
  })
});
var WeatherLocationOpenAPI = class extends OpenAPIRoute {
  static {
    __name(this, "WeatherLocationOpenAPI");
  }
  schema = {
    tags: ["Weather"],
...
// src/docs/endpoints/weather/getWeatherLondon.ts
var WeatherResponseSchema2 = external_exports.object({
  success: external_exports.boolean(),
  data: external_exports.object({
    location: external_exports.string(),
    country: external_exports.string(),
...
var WeatherLondonOpenAPI = class extends OpenAPIRoute {
  static {
    __name(this, "WeatherLondonOpenAPI");
  }
  schema = {
    tags: ["Weather"],
...
// src/docs/endpoints/auth/signup.ts
var SignupRequestSchema = external_exports.object({
  username: external_exports.string().min(3).max(50),
  email: external_exports.string().email(),
  password: external_exports.string().min(8).max(100)
});
var SignupResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  message: external_exports.string(),
  data: external_exports.object({
    username: external_exports.string(),
...
var SignupOpenAPI = class extends OpenAPIRoute {
  static {
    __name(this, "SignupOpenAPI");
  }
  schema = {
    tags: ["Authentication"],
    ...
    responses: {
            ...
            schema: {
              ...
              properties: {
                ...
                data: {
                  ...
                  description: "Created user information (password is not returned for security)"
                }
              }
            },
            examples: {
      ...
      "400": {
        description: "Invalid request body - Validation errors in the provided data",
        content: {
          "application/json": {
            schema: {
              type: "object",
...
// src/docs/endpoints/auth/login.ts
var LoginRequestSchema = external_exports.object({
  username: external_exports.string(),
  password: external_exports.string()
});
var LoginResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  message: external_exports.string(),
  data: external_exports.object({
...
var LoginErrorResponseSchema = external_exports.object({
  success: external_exports.boolean(),
  error: external_exports.string(),
  details: external_exports.array(external_exports.any()).optional()
});
var LoginOpenAPI = class extends OpenAPIRoute {
  static {
    __name(this, "LoginOpenAPI");
  }
  schema = {
    tags: ["Authentication"],
                ...
                data: {
                  ...
                  properties: {
                    token: {
                      ...
                      example: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsInVzZXJuYW1lIjoidGVzdHVzZXIiLCJlbWFpbCI6InRlc3RAZXhhbXBsZS5jb20iLCJpYXQiOjE2ODk2NzIwMDAsImV4cCI6MTY4OTY3NTYwMH0.signature"
                    },
                    user: {
                      type: "object",
                      properties: {
            ...
            examples: {
              "successful-login": {
                ...
                value: {
                  ...
                  message: "Login successful",
                  data: {
                    token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsInVzZXJuYW1lIjoidGVzdHVzZXIiLCJlbWFpbCI6InRlc3RAZXhhbXBsZS5jb20iLCJpYXQiOjE2ODk2NzIwMDAsImV4cCI6MTY4OTY3NTYwMH0.signature",
                    user: {
                      id: 1,
                      username: "testuser",
                      email: "test@example.com"
...
// .wrangler/tmp/bundle-l3MJ4j/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-l3MJ4j/middleware-loader.entry.ts
